...
<template>
    ...
    <div class="wrapper_container row bg-white border">
        ...
        <div class="col-12">
            ...
            <ol>
                <li>Before accomplishing this form, please know your H.A.P. ID, Visa Subclass Name and Number, and the Lodgement Office where your visa application was filed.</li>
        ...
        <div class="col-12">
            <CalloutDanger 
                ...
                description="
                <strong>
                    To set an appointment for DNA testing for Australia, kindly send an email to dna.aupanel@slec.ph or call us thru (+632) 8526-0208.
                </strong>
                "
            />
        </div>
