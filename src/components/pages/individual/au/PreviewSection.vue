<script setup>
    ...
    const handleDetails = async () => {
        ...
        const JSONdata = {
           ...
           json_sched_branch: sched_branch,
           json_userId: user_id,
                ...
                <div class="card-body row">
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 mb-3">
                        <PreviewText 
                            ...
                            v-bind:previewText="wasFirstMedExam"
                        />
                    </div>
                        ...
                        <ol>
                            ...
                            <li>
                                <PreviewText 
                                    ...
                                    v-bind:previewText="intentStayDuration"
                                />
                                <hr/>
                            </li>
                            <li>
                                <PreviewText 
                                    ...
                                    v-bind:previewText="intentToWork"
                                />
                                <hr/>
                            </li>
                            <li>
                                <PreviewText 
                                    ...
                                    v-bind:previewText="intentToStay"
                                />
                                <hr/>
                            </li>
                            <li>
