...
<template>
    ...
    <div class="wrapper_container row bg-white border">
        ...
        <div class="col-12">
            ...
            <ol>
                <li>You must have your received your Medical Examination Instruction Letter from the Canadian Embassy before proceeding to the Medical Examination.</li>
