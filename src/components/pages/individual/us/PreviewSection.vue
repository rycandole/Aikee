...
let detail_ad_passport_expiration_date = moment(
...
const handleStore = async () => {
  ...
  const JSONdata = {
    ...
    json_detail_ad_passport_expiration_date: moment(
      details.ad_passport_expiration_date
    ).format("YYYY-MM-DD"),
    json_detail_ad_has_been_issued_visa:
    ...
    json_detail_petitioner_is_alive:
      detail_petitioner_is_alive == "yes"
        ? (detail_petitioner_is_alive = 1)
        : (detail_ad_has_been_issued_visa = 0),
  ...
  try {
    ...
    if (res.data.status_code === 200) {
      ...
      Swal.fire(
        ...
        "Please check the fields or contact the administrator",
        "info"
      );
      console.log("Reject, " + res.data.status_code + ", " + res.data.error);
    }
    ...
    >
      <div class="col-12 mb-3">
        <div class="card-body row">
          ...
          <div class="mb-1 col-lg-4 col-md-12 col-sm-12">
            <PreviewText previewLabel="Email Address" v-bind:previewText="email" />
          </div>
          ...
          <div class="col-12 mt-4 border-top container-fluid p-3 irc_div">
            ...
            <div class="form-check">
              ...
              <label class="form-check-label" for="flexCheckDefault">
                I certify that the information provided in my registration is true and
                correct to the best of my knowledge and understand that any dishonest
                answer may cause delay in the process of my medical examination.
              </label>
            </div>
            <div class="form-check">
            ...
            <div class="form-check">
              <p class="mt-3">
                I understand that ST. LUKE'S MEDICAL CENTER EXTENSION CLINIC needs to
                collect my personal information for the conduct of my medical examination
                required for my U.S. Visa Application. For this purpose, the information
                will be shared to the U.S. Embassy Manila. The information provided shall
                be processed and retained in accordance with the Data Privacy Act and the
                regulation of the Centers for Disease Control and Prevention and the U.S.
                Government.
              </p>
            </div>
          </div>
