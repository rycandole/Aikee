...
const showInformation = async () => {
  ...
  for (var i = 0; i < showApplication.length; i++) {
    ...
    prevCategory.value = showApplication[i].prevCategory || ''
    ...
    wasFirstMedicalExam.value == 'N' ? hasMedicalExam = true : hasMedicalExam = false
    wasFirstMedicalExam.value === 'Y' ? prevClinicName.value = "" : prevClinicName.value = showApplication[i].prevClinicName
    wasFirstMedicalExam.value === 'Y' ? prevCategory.value = "" : prevCategory.value = showApplication[i].prevCategory
