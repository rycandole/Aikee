...
onMounted(async () => {
  showInformation();
  await TRIPLETS_MNL_Holidates.fetchHolidaysByCountryAndBranch(ucwords(country), 'MNL')
  await TRIPLETS_BGC_Holidates.fetchHolidaysByCountryAndBranch(ucwords(country), 'BGC')
  handleSlots();
  // handleDateTime();
