...
import PreviewSection from '@/components/pages/individual/ca/PreviewSection.vue'
import CA_TimerAlertBox from "@/components/global/CA_TimerAlertBox.vue";
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="row timerAlertBoxDiv">
                <div class="col-12">
                  <CA_TimerAlertBox divClassName="timerAlertBox" />
                </div>
              </div>
